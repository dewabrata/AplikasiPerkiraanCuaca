...
public class List implements Serializable, Parcelable
{
    ...
    ;
    private final static long serialVersionUID = 7688446356970140622L;

    protected List(Parcel in) {
        this.dt = ((Integer) in.readValue((Integer.class.getClassLoader())));
        this.main = ((Main) in.readValue((Main.class.getClassLoader())));
        in.readList(this.weather, (com.juara.aplikasiperkiraancuaca.model.forecast.Weather.class.getClassLoader()));
